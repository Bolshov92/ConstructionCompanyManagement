INSERT INTO authority (id, authority, role_id)
VALUES (UUID_TO_BIN('42cd0d41-8705-44fc-a7d5-fa8a0beb0540'), 'User1', NULL);

INSERT INTO role (role_id, role_name, user_id)
VALUES (UUID_TO_BIN('bc878cd0-6ace-44e5-947e-ea9ad03b28eb'), 'ROLE_ADMIN', NULL),
       (UUID_TO_BIN('52796ae8-e56d-4e3d-81a4-059c22f170e7'), 'ROLE_USER', NULL);
...
VALUES (UUID_TO_BIN('639d7bc4-9845-40aa-84c8-b0f1dced6732'), 'Alice', 'Smith', 'alice@example.com', 30, '2020-01-01', '2023-01-01', UUID_TO_BIN('02614a58-e256-482c-9284-c188c00a7ec6')),
       (UUID_TO_BIN('a2b4f08a-734e-42c7-83e1-ccea7d50a461'), 'Jake', 'Min', 'jake@example.com', 20, '2022-01-01', '2023-01-01', UUID_TO_BIN('02614a58-e256-482c-9284-c188c00a7ec6'));

...
VALUES (UUID_TO_BIN('f2165341-4c7f-4c20-af08-7d0962ac4777'), 'admin', '$2a$10$cYu7fQrsV6pbw0QVjZQaI.rPFZBS6O0pwR86iAU8uwkkLw7BWX17.', '123456789', UUID_TO_BIN('0f9368f4-518f-48cb-b917-2f0f967dd41e'));

INSERT INTO users (date_of_birth, first_name, last_name, registration_date, id, user_info_id, role_id)
VALUES ('1990-01-01', 'Nik', 'Jameson', '2024-04-29', UUID_TO_BIN('0f9368f4-518f-48cb-b917-2f0f967dd41e'), UUID_TO_BIN('f2165341-4c7f-4c20-af08-7d0962ac4777'), UUID_TO_BIN('bc878cd0-6ace-44e5-947e-ea9ad03b28eb'));
